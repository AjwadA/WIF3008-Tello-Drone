...
import cv2
import numpy as np
from greeting_drone_main import moveDrone
...
# Setup the Colour Picker (Lower Boundery)
...
# Setup the Colour Picker (Higher Boundery)
...
while True:
    ...
    # Use flags to detect if colour has been detected
    ...
    # Show original frame and the processed frame
    cv2.imshow("Original Frame", frame)
    cv2.imshow("Masked Frame", result)

    # Exit program using lowercase 'q'
