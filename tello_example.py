...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Part 1: We are going to show a flight using sequential
# control flow.
#++++++++++++++++++++++++++++++++++++++++++++++++++++++

print("Drone is moving forward for 50 cm.")
billy.send("forward " + str(50), 10)

#  Find Red
# 

print("Drone is going to do a backward flip!")
billy.send("flip b", 5)

print("Drone is turning counterclockwise for 180 degrees.")
billy.send("ccw " + str(180), 15)
